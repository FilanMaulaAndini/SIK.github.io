                                        ...
                                        <td class="text-right">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    ...
                                                    <a class="dropdown-item" href="<?php echo base_url() . 'Surat_KetJandaDuda/sunting_data/' . $surat->No_surat ?>">Sunting</a>
                                            ...
                                            <div class="modal fade bd-example-modal-sm" id="modal_hapus<?php echo $surat->No_surat; ?>" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-sm" role=document>
                                                    <div class="modal-content">
                                                        <form class="form-horizontal" method="post" action="<?php echo base_url() . 'Surat_KetJandaDuda/hapus_data/' . $surat->No_surat ?>">
