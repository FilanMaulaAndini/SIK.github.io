        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header border-0">
              <h3 class="mb-0">Lihat Surat Permohonan KTP</h3>
            </div>    
            <!-- Card footer -->
                      ...
                      <th scope="row">
                        <div class="media align-items-center">
                          ...
                          <div class="media-body">
                            ...
                            <br><span class="name mb-0 text-sm"><span class="name mb-0 text-sm "><?php echo $detail->Nama_Lengkap ?></span>
                          </div>
                        </div>
                      </th>
                      <td class="text-right">
                      <?php echo anchor('Surat_PermohonanKTP/cetak/' . $detail->No_surat, '<div class="btn btn-primary my-2">Cetak</div>') ?>
                      </td>
                    </tr>
                  </tbody>
                </table>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                        <div class="form-group">
                          ...
                          <input type="text" id="input-goldar" class="form-control" disabled value="<?php echo $detail->Gol_darah ?>">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="form-group">
                          ...
                          <input type="text" id="input-status" class="form-control" disabled value="<?php echo $detail->Status_kawin ?>">
                        </div>
                      </div>
                    </div>
                    <div class="row">
