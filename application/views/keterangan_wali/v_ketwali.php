                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group mb-0">
                                <?php echo form_open('Surat_KetWali/search') ?>
                ...
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        ...
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                <li class="breadcrumb-item"><a href="<?= base_url(); ?>Surat_KetWali"><i class="fas fa-home"></i></a></li>
                                <li class="breadcrumb-item active" aria-current="page">Surat Keterangan Wali</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col-lg-6 col-5 text-right">
                        <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <div class="media align-items-center">
                                <div class="media-body  ml-2  d-none d-lg-block">
                                    <a class="mb-0 text-sm  btn btn-sm btn-neutral" href="<?= base_url(); ?>Surat_KetWali/btn_tambah">Tambah</a>
                                </div>
                            </div>
                        </a>
                    </div>
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-header border-0">
                        <h3 class="mb-0">Daftar Surat Keterangan Wali</h3>
                    </div>
                    <!-- Light table -->
                        ...
                        <table class="table align-items-center table-flush">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th scope="col" class="sort" data-sort="jeniskelamin">Wali dari</th>
                                    <th scope="col"></th>
                                </tr>
                            </thead>
                            <tbody class="list">
                                ...
                                foreach ($kependudukan as $surat) : ?>
                                    <tr>
                                        ...
                                        <td><?php echo $surat->Wali_dari ?></td>
                                        <td class="text-right">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    ...
                                                    <a class="dropdown-item" href="<?php echo base_url() . 'Surat_KetWali/lihat_data/' . $surat->No_surat ?>">Lihat</a>
                                                    <a class="dropdown-item" href="<?php echo base_url() . 'Surat_KetWali/sunting_data/' . $surat->No_surat ?>">Sunting</a>
                                            ...
                                            <div class="modal fade bd-example-modal-sm" id="modal_hapus<?php echo $surat->No_surat; ?>" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-sm" role=document>
                                                    <div class="modal-content">
                                                        <form class="form-horizontal" method="post" action="<?php echo base_url() . 'Surat_KetWali/hapus_data/' . $surat->No_surat ?>">
