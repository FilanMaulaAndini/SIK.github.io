            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-header border-0">
                        <h3 class="mb-0">Sunting Surat Permohonan KK (Baru)</h3>
                    </div>
                    <!-- Card footer -->
                    <div class="card-footer py-4">
                            <form method="post" action="<?php echo base_url() . 'Surat_PermohonanKK/update_data' ?>">
                                <div class="row">
                                    <div class="col-lg-6">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="pekerjaan[]" class="form-control" value="<?php echo $surat['pekerjaan'] ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
