        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-header border-0">
                    <h3 class="mb-0">Tambah Surat Permohonan KK (Baru)</h3>
                </div>
                <!-- Card footer -->
                <div class="card-footer py-4">
                        <form method="post" action="<?php echo base_url() . 'Surat_PermohonanKK/tambah_data'; ?>">

                            <input type="hidden" name="jenis_surat" class="form-control" value="Surat Permohonan KK Baru">
                            <!-- </div> -->
                            <!-- </div>
                        </div> -->
                            <div class="row">
